...
param(
 ...
 [string]
 $templateFilePath = ".\azuredeploy1.json",

 [string]
 $parametersFilePath = ".\azuredeploy.parameters1.json"
)
...
#>
# Register RPs
$resourceProviders = @("microsoft.network","microsoft.resources","microsoft.sql");
